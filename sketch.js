...
//let model = 'https://teachablemachine.withgoogle.com/models/LTDbCOCmB/';
let model = 'https://teachablemachine.withgoogle.com/models/CzSG4o7bA/';

function preload() {
  classifier = ml5.imageClassifier(model, classifyVideo)
